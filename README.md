<p align="center">
  <a href="https://github.com/SNDST00M/material-dynmap">
    <img alt="logo" title="material-dynmap" src="https://cdn.jsdelivr.net/gh/SNDST00M/material-dynmap@v0.8.0/assets/icon.svg" width="100" alt="Logo">
  </a>
...
<p align="center"><a href="https://openuserjs.org/scripts/SNDST00M/Material_Dynmap" target="_blank"><img src="https://cdn.jsdelivr.net/gh/SNDST00M/material-dynmap@v0.8.0/assets/westeroscraft-map.png"/></a></p>

> The Red Keep in King's Landing on the [WesterosCraft Minecraft server][westeroscraft].

<p align="center"><a href="https://openuserjs.org/scripts/SNDST00M/Material_Dynmap" target="_blank"><img src="https://cdn.jsdelivr.net/gh/SNDST00M/material-dynmap@v0.8.0/assets/ardacraft-map.png"/></a></p>

> The Seven Towers in Isengard on the [ArdaCraft Minecraft server][ardacraft].

<p align="center"><a href="https://openuserjs.org/scripts/SNDST00M/Material_Dynmap" target="_blank"><img src="https://cdn.jsdelivr.net/gh/SNDST00M/material-dynmap@v0.8.0/assets/earthmc-login.png"/></a></p>
