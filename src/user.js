...
// @license	        MIT
// @homepage        https://github.com/SNDST00M/material-dynmap/blob/v0.3.0/README.md
// @icon            https://raw.githubusercontent.com/SNDST00M/material-dynmap/v0.3.0/assets/icon.png
...
(function(window, factory) {
	...
	if (login) {
		const loginStyle = GM_addElement("link", {
			href: "https://cdn.jsdelivr.net/npm/material-dynmap@0.3.0/src/login.css",
			rel: "stylesheet"
		});
		...
		const style = GM_addElement("link", {
			href: "https://cdn.jsdelivr.net/npm/material-dynmap@0.3.0/src/main.css",
			media: "not all",
			rel: "stylesheet"
		});
		...
		const script = GM_addElement("script", {
			src: "https://cdn.jsdelivr.net/npm/material-dynmap@0.3.0/src/app.js",
	...
	window.document.head
		...
		.href = "https://cdn.jsdelivr.net/npm/material-dynmap@0.3.0/assets/icon.ico";
}));
