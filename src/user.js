...
// @license	        MIT
// @homepage        https://github.com/SNDST00M/material-dynmap/blob/v0.8.1/README.md
// @icon            https://cdn.jsdelivr.net/gh/SNDST00M/material-dynmap@v0.8.1/assets/icon.png
...
(function(window, factory) {
	...
	if (login) {
		...
		loginStyle.href = "https://cdn.jsdelivr.net/npm/material-dynmap@0.8.1/src/login.css";
		...
		style.href = "https://cdn.jsdelivr.net/npm/material-dynmap@0.8.1/src/main.css";
		...
		script.src = "https://cdn.jsdelivr.net/npm/material-dynmap@0.8.1/src/app.js";
		window.document.head.appendChild(script);
	}

	window.document.head
		.querySelector("link[rel='icon']")
		.href = "https://cdn.jsdelivr.net/npm/material-dynmap@0.8.1/assets/icon.ico";
}));
