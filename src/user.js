...
// @license	        MIT
// @homepage        https://github.com/SNDST00M/material-dynmap/blob/v0.2.1/README.md
// @icon            https://raw.githubusercontent.com/SNDST00M/material-dynmap/v0.2.1/assets/icon.png
...
(function(window, factory) {
	...
	if (login) {
		const loginStyle = GM_addElement("link", {
			href: "https://unpkg.com/material-dynmap@0.2.1/src/login.css",
			rel: "stylesheet"
		});
	...
	const style = GM_addElement("link", {
		href: "https://unpkg.com/material-dynmap@0.2.1/src/main.css",
		media: "not all",
		rel: "stylesheet"
	});
	...
	const script = GM_addElement("script", {
		src: "https://unpkg.com/material-dynmap@0.2.1/src/app.js",
